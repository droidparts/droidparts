...
public class RESTClientTestCase extends AndroidTestCase {
	...
	// Simple server for testing POST requests. Supports multipart/form-data file uploads.
	...
	private void assertPostMultipartFileResponse(HTTPResponse response) throws HTTPException {
